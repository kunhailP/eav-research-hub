...
- 규모 (2026-09-14 확인, **집단별 잔차는 계산하지 않음**): 선언문 235개 · 21개국(동유럽 68개) · 1989–2019 · 전문가 평균이 있는 선언문×이슈 1,307칸(LLM 앙상블까지 있는 분석 가능 칸은 1,264칸, 2026-09-14 정정·D33) · 급진우파 27 · 녹색 24 · 이슈 6개(세금·지출, 사회, EU, 이민, 환경, 분권).
